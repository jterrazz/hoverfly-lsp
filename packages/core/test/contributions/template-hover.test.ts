...
describe('template hover — helpers', () => {
    test('shows signature, arity, kind and example for an inline helper', async () => {
...
describe('template hover — faker', () => {
    test('describes a known faker type as a zero-arg gofakeit method with the version', async () => {
...
describe('template hover — Request members', () => {
    test('documents Request.Body with the kubectl-JSONPath / xsel dialect note', async () => {
